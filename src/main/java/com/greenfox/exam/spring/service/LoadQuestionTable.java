...
public class LoadQuestionTable implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) throws Exception {
    ...
    questionRepository.save(new Question("How many classes are learning at Green Fox Academy at this moment?", "4"));
    questionRepository.save(new Question("How many mentors teach at Green Fox at this moment?", "16"));
    questionRepository.save(new Question("What was the name of the first Green Fox class?", "Vulpes"));
